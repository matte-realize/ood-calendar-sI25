...
public class CalendarControllerQueryEventTest extends AbstractControllerEventTest {
  ...
  public void testPrintEventsOnADay() {
    ...
    QueryCommand printCommand = new QueryCommand(printEvent, "print",
  ...
  public void testPrintEventsOnARange() {
    ...
    QueryCommand printCommand1 = new QueryCommand(printEventOnRange1, "print",
            calendarManagement, calendarView);
    ...
    QueryCommand printCommand2 = new QueryCommand(printEventOnRange2, "print",
            calendarManagement, calendarView);
  ...
  public void testDisplayExpectedEvent() {
    ...
    QueryCommand showStatusCommand1 = new QueryCommand(showStatus1, "",
            calendarManagement, calendarView);
    showStatusCommand1.execute();

    String showStatus2 = "show status on 2025-08-10T09:00";
    QueryCommand showStatusCommand2 = new QueryCommand(showStatus2, "",
            calendarManagement, calendarView);
